                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="row">    
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" name="gapok" id="gapok" class="form-control" onkeyup="hitung();" required="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label for="name">Tunjangan</label>
                                                <input type="number" name="tunjangan" id="tunjangan" class="form-control" onkeyup="hitung();" value="0" required="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <div class="row">    
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" name="insentiv" id="insentiv" class="form-control" onkeyup="hitung();" value="0" required="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label for="name">Tunjangan Hari Raya(THR)</label>
                                                <input type="number" name="thr" id="thr" class="form-control" onkeyup="hitung();" value="0" required="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <div class="row">    
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="bpjs-kes" id="bpjs-kes" class="form-control" onchange="hitung();" value="" readonly="" required="" />
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="bpjs-tk" id="bpjs-tk" class="form-control" onkeyup="hitung();" readonly="" required="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="control-label">Gaji Bruto</label>
                                        <input maxlength="100" name="gaji_bruto" id="gaji_bruto" type="text" required="required" readonly="readonly" class="form-control" placeholder="Gaji Bruto" onkeyup="hitung();"/>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="row">    
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" name="pph21" id="pph21" class="form-control" onkeyup="hitung();" value="0" required="" />
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="number" name="pinjaman" id="pinjaman" class="form-control" onkeyup="hitung();" oninput="hitung();" value="" required="" readonly="" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="row">    
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="p-bpjs-kes" id="p-bpjs-kes" class="form-control" onkeyup="hitung();" readonly="" required="" />
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="p-bpjs-tk" id="p-bpjs-tk" class="form-control" onkeyup="hitung();" readonly="" required="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="control-label">Gaji Bersih</label>
                                        <input maxlength="100" name="gaji_bersih" id="gaji_bersih" type="text" required="required" class="form-control" readonly="" placeholder="Gaji Bersih"/>
                                    </div>
                                    <div class="form-group col-md-12">
