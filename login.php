        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Nomer Induk Kepegawaian" aria-label="No Induk Kepegawaian" aria-describedby="basic-addon1" name="nip" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                ...
                <div id="recoverform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" method="post" action="user/registrasi-user.php">
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="text" name="nip" class="form-control form-control-lg" placeholder="Nomer Induk Pegawai" aria-label="Username" aria-describedby="basic-addon1" required>
                                </div>
                                <!-- email -->
                                <!-- <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="text" name="domain" class="form-control form-control-lg" aria-label="Username" aria-describedby="basic-addon1" readonly="" value="@lrcom.co.id">
                                </div> -->
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" name="k_password" class="form-control form-control-lg" placeholder=" Confirm Password" aria-label="Password" aria-describedby="basic-addon1" required>
                                </div>
                            </div>
                        </div>
                            <div class="row border-top border-secondary">
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="p-t-20">
                                            ...
                                            <button class="btn btn-info float-right" name="registrasi" type="submit">Sign Up</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
