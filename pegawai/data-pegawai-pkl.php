                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle="tooltip" title="Lihat Detail" href="?view=detail-pegawai&id=997386798hupa&name=pegaaplication&detailPegawai&nip=<?php echo $row['nik'];?>">
                                                        ...
                                                        <a href=
                                                    "config_config_cs/non-aktif-pegawai-con.php?id=<?php echo $row['nik']; ?>&hal=data-pegawai-pkl&add=pegawaiPKL" data-toggle="tooltip" title="Non Aktifkan" onclick='/return konfirmasi("
                                                    Menghapus data <?php echo $row['nik'];?>")'><span class='fa fa-times'></span></a>
                                                    <?php    
                                                    } else { ?>
                                                        <a href=
                                                    "config_config_cs/aktif-pegawai-con.php?id=<?php echo $row['nik']; ?>&hal=data-pegawai-pkl&add=pegawaiPKL" data-toggle="tooltip" title="Aktifkan" onclick='/return konfirmasi("
